      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='w-full bg-cyan-300 h-36 flex '>
          <div className='h-2/3 bg-white w-1/2 my-auto ml-10 drop-shadow-xl border-none rounded-lg'>
            ...
            <p className='pl-10 pt-1 text-orange-400 font-semibold text-2xl'>Hostel Registration Form</p>
          </div>
        </div>
          ...
          <div className="bg-orange-100 w-11/12 h-auto mt-10 border-none rounded-lg flex justify-center">
            <div className='w-5/6 h-auto mt-5 mb-5 ml-6 mr-6 flex flex-col'>
              ...
              <div className='w-full h-auto flex flex-col mt-3'>
                <div className="mb-1 " htmlFor="description">Hostel Name *</div>
                <input
                  id="hostel_name"
                  name="hostel_name"
              ...
              {/* 1.2 */}
              <div className='w-full h-auto flex flex-col mt-3'>
                <div className="mb-1 " htmlFor="description">Hostel Description *</div>
                <textarea
                  id="description"
                  name="description"
            ...
            <div className='w-full h-auto flex justify-between'>
                <div className='w-1/2'>
                  <div className="mb-1 " htmlFor="email_id">Address Line 1 **</div>
                    <input
                      type="text"
                      id="address1"
                      name="address1"
