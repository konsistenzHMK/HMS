...
const RoomRegistartion = () => {
  ...
  const handleDropdownStatus = (event) => {
    ...
    setFormData((prevData) => ({
      ...prevData, room_status: event.target.value
    }));
  }
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      ...
      axios.post(`${SecretKeys.API_URL}/hostel/room`, formData).then((response) => {
  ...
  const wing_name_and_id_fetch = async () => {
    try {
      const response = await fetch(`${SecretKeys.API_URL}/get_wing_id_where_status_active?tower_id=${formData.tower_id}`, {
        method: "GET", headers: {"Content-Type": "application/json"},
      });
      if (response.ok) {
        const result = await response.json();
  ...
  const handleChange2 = (event) => {
    setFormData((prevFormData) => ({
      ...prevFormData, wing_id: event.target.value,
    }));
  };
  ...
  const tower_name_and_id_fetch = async () => {
    try {
      const response = await fetch(`${SecretKeys.API_URL}/get_tower_id_where_status_active?hostel_id=${formData.hostel_id}`, {
        method: "GET", headers: {"Content-Type": "application/json"},
      });
      if (response.ok) {
        const result = await response.json();
  ...
  const handleChange3 = (event) => {
    setFormData((prevFormData) => ({
      ...prevFormData, tower_id: event.target.value,
    }));
    wing_name_and_id_fetch();
  };
          ...
          <div className='w-5/6 h-auto mt-5 mb-5 ml-6 mr-6 flex flex-col font-popins'>
            ...
            <div className='w-full h-auto flex flex-col mt-1'>
              ...
              <select
                id="hostel_id"
                name="hostel_id"
                value={formData.hostel_id} // Use formData.hostel_name_or_id to pre-select the dropdown option based
                // on the state
            ...
            <div className='w-full h-auto flex flex-col mb-2 mt-2'>
              <div className="mb-1 font-popins text-lg font-medium " htmlFor="description">Tower <p
                className='inline text-xl text-red-600'>*</p></div>
              <select
                id="tower_id"
                name="tower_id"
              ...
              >
                <option value="" disabled>-- Select an option --</option>
                \
                {tower_name_and_id.map((item) => (<option value={item[0]}>{item[1] + "  |  " + item[0]}</option>))}
              </select>
            ...
            <div className='w-full h-auto flex flex-col mb-2 mt-2'>
              ...
              <div className="mb-1 font-popins text-lg font-medium " htmlFor="description">Wing <p
                className='inline text-xl text-red-600'>*</p></div>
              <select
                id="wing_id"
                name="wing_id"
              ...
              >
                <option value="" disabled>-- Select an option --</option>
                \
                {wing_name_and_id.map((item) => (<option value={item[0]}>{item[1] + "  |  " + item[0]}</option>))}
              </select>
            ...
            <div className='w-full h-auto flex justify-between mt-1'>
              <div className='w-1/2'>
                <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">Name of Room <p
                  className='inline text-xl text-red-600'></p></div>
                <input
                  type="text"
                  id="room_name"
              ...
              <div className='w-1/2 flex flex-col items-end mb-2 mt-1'>
                <div className='w-11/12'>
                  ...
                  <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">Room Number <p
                    className='inline text-xl text-red-600'>*</p></div>
            ...
            <div className='w-full h-auto flex justify-between mt-1'>
              ...
              <div className='w-1/2 flex flex-col items-end mb-2 mt-1'>
                <div className='w-11/12'>
                  <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">Room capacity <p
                    className='inline text-xl text-red-600'>*</p></div>
                  <input
                    type="text"
                    id="room_capacity"
            ...
            <div className='w-full h-auto flex justify-between mt-3'>
              <div className='w-1/3 flex flex-col items-start'>
                <div className='w-11/12'>
                  <div className="mb-1 font-popins text-lg font-medium   " htmlFor="email_id">Height (m) <p
                    className='inline text-xl text-red-600'>*</p></div>
                  <input
                    type="text"
                    id="height"
              ...
              <div className='w-1/3 flex flex-col items-center'>
                <div className='w-11/12'>
                  <div className="mb-1 font-popins text-lg font-medium   " htmlFor="email_id">Width (m) <p
                    className='inline text-xl text-red-600'>*</p></div>
                  <input
                    type="text"
                    id="width"
              ...
              <div className='w-1/3 flex flex-col items-end'>
                <div className='w-11/12'>
                  <div className="mb-1 font-popins text-lg font-medium   " htmlFor="email_id">Length (m) <p
                    className='inline text-xl text-red-600'>*</p></div>
                  <input
                    type="text"
                    id="length"
            ...
            <div className='w-full h-auto flex justify-between mt-1'>
              ...
              <div className='w-1/2 flex flex-col items-end mb-2 mt-1'>
                <div className='w-11/12'>
                  <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">No of Windows <p
                    className='inline text-xl text-red-600'></p></div>
                  <input
                    type="text"
                    id="no_of_windows"
            ...
            <div className='w-full h-auto flex justify-between mt-1'>
              ...
              <div className='w-1/2 flex flex-col items-end mb-2 mt-1'>
                <div className='w-11/12'>
                  ...
                  <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">Room Status<p
                    className='inline text-xl text-red-600'>*</p></div>
                  <select
                    type="text"
                    id="room_status"
