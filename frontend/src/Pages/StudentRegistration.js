...
const Page1 = ({currentPage, formData, setFormData, nextPage, display}) => {
  ...
  const getStatesByCountryId = (countryId) => {
    axios.get(`https://www.universal-tutorial.com/api/getaccesstoken`, {
      headers: ({
        "Accept": "application/json", "api-token": SecretKeys.API_Token, "user-email": SecretKeys.User_Email,
      }),
    }).then((response) => {
      ...
      axios.get(`https://www.universal-tutorial.com/api/states/${countryId}`, {
        headers: ({
          "Authorization": `Bearer ${myAuth}`, "Accept": "application/json"
        }),
      }).then((response) => {
  ...
  const handleStateChange = (event) => {
    ...
    setFormData((prevData) => ({
      ...prevData, state: event.target.value
    }));
  ...
  const handleCityChange = (event) => {
    ...
    setFormData((prevData) => ({
      ...prevData, city: event.target.value
    }));
  }
  ...
  const changeAddress = (event) => {
    setFormData((prevData) => ({
      ...prevData, address_type: event.target.value
    }));
  }
  ...
  const changeOrphan = (event) => {
    setFormData((prevData) => ({
      ...prevData, orphan: event.target.value
    }));
  }
  
  const changeHandicappStatus = (event) => {
    setFormData((prevData) => ({
      ...prevData, handicapped: event.target.value
    }));
  }
  
  const changeHandicappType = (event) => {
    setFormData((prevData) => ({
      ...prevData, handicapped_type: event.target.value
    }));
  }
  ...
  useEffect(() => {
    ...
    if (errors.length === 0) setSendForm(false); else setSendForm(true)
    console.log(errors);
  }, [formData])
  ...
  return (<div className="flex bg-defaultBg">
      {/* Main Content */}
          ...
          <div className='w-full h-full bg-defaultBg flex justify-center font-popins'>
            <div className="bg-white  w-10/12 h-auto mt-10 border-none rounded-lg flex justify-center font-popins">
              <div className='w-5/6 h-auto mt-5 mb-5 ml-6 mr-6 flex flex-col font-popins'>
                {/* 1 --> Basic Details */}
                <div
                  className='font-semibold underline  underline-offset-1 text-sky-950 text-2xl pt-3 mb-3 font-popins'>
                  <p className='font-popins'>Basic Details</p>
                </div>
                {/* 1.1 -- Student Name*/}
                <div className='w-full h-auto flex justify-between'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">First Name <p
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium" htmlFor="email_id">Last Name <p
                        className='inline text-xl text-red-600'>*</p></div>
                      <input
                        type="text"
                        id="last_name"
                ...
                <div className='w-full h-auto flex justify-between mt-2'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">Father's Name <p
                      className='inline text-xl text-red-600'>*</p></div>
                    <input
                      type="text"
                      id="father_name"
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium" htmlFor="email_id">Mother's Name <p
                        className='inline text-xl text-red-600'>*</p></div>
                      <input
                        type="text"
                        id="mother_name"
                ...
                <div className='w-full h-auto flex justify-between mt-3'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium   " htmlFor="email_id">Gender <p
                      className='inline text-xl text-red-600'>*</p></div>
                    <select
                      className='w-full border-gray-400 rounded-md font-montserrat px-1 py-1 focus:outline-none border-1 focus:border-orange-600 focus:border-1.5'
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium w-full">Date of Birth <p
                        className='inline text-xl text-red-600'>*</p></div>
                      {/* <DatePicker
                ...
                <div className='w-full h-auto flex justify-between mt-3'>
                  <div className='w-full flex flex-col items-start'>
                    <div className='w-full'>
                      <div className="mb-1 font-popins text-lg font-medium" htmlFor="email_id">Aadhar Number <p
                        className='inline text-xl text-red-600'>*</p></div>
                      <input
                        type="text"
                        id="aadhar_id"
                ...
                <div className='w-full h-auto flex justify-between mt-2'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">Religon<p
                      className='inline text-xl text-red-600'>*</p></div>
                    <input
                      type="text"
                      id="religon"
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium" htmlFor="email_id">Category<p
                        className='inline text-xl text-red-600'>*</p></div>
                      <input
                        type="text"
                        id="category"
                ...
                <div className='w-full h-auto flex justify-between mt-4'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium " htmlFor="email_id">Height (in cm)<p
                      className='inline text-xl text-red-600'></p></div>
                    <input
                      type="Number"
                      id="height"
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium" htmlFor="email_id">Weight (in kg) <p
                        className='inline text-xl text-red-600'></p></div>
                      <input
                        type="Number"
                        id="weight"
                ...
                <div className='w-full h-auto flex justify-between mt-4'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium " htmlFor="email_id">Handicapped <p
                      className='inline text-xl text-red-600'></p></div>
                    <select
                      className='w-full border-gray-400 rounded-md font-montserrat px-1 py-1 focus:outline-none border-1 focus:border-orange-600 focus:border-1.5 '
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium " htmlFor="medical_history">Handicapped
                        Percentage<p className='inline text-xl text-red-600'></p></div>
                      <input
                ...
                <div className='w-full h-auto flex justify-between mt-4'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium " htmlFor="email_id">Handicapped Type <p
                      className='inline text-xl text-red-600'></p></div>
                    <select
                      disabled={formData.handicapped === 'false' ? true : false}
                      className='w-full border-gray-400 rounded-md font-montserrat px-1 py-1 focus:outline-none border-1 focus:border-orange-600 focus:border-1.5'
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium " htmlFor="medical_history">Orphan<p
                        className='inline text-xl text-red-600'></p></div>
                      <select
                        className='w-full border-gray-400 rounded-md font-montserrat px-1 py-1 focus:outline-none border-1 focus:border-orange-600 focus:border-1.5'
                ...
                <div
                  className='font-semibold underline  underline-offset-1 text-sky-950 text-2xl pt-4 mb-2 font-popins'>
                  <p className=' font-popins'>Address </p>
                </div>
                
                <div className='w-full h-auto flex justify-between mt-2'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">Address Line 1<p
                      className='inline text-xl text-red-600'>*</p></div>
                    <input
                      type="text"
                      id="address1"
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium   " htmlFor="email_id">Address Line 2 <p
                        className='inline text-xl text-red-600'></p></div>
                      <input
                        type="text"
                        id="address2"
                ...
                <div className='w-full h-auto flex justify-between mt-3'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">Country <p
                      className='inline text-xl text-red-600'>*</p></div>
                    <input
                      type="text"
                      id="state"
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">State <p
                        className='inline text-xl text-red-600'>*</p></div>
                      ...
                      >
                        ...
                        {allState.map((state) => (<option value={state.state_name}>
                          {state.state_name}
                        </option>))}
                      </select>
                ...
                <div className='w-full h-auto flex justify-between mt-3'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">City <p
                      className='inline text-xl text-red-600'>*</p></div>
                    ...
                    >
                      ...
                      {allCity.map((city) => (<option value={city.city_name}>
                        {city.city_name}
                      </option>))}
                    </select>
                    {errors.state && <span className="error text-red-500">{errors.state}</span>}
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium   " htmlFor="email_id">Pincode <p
                        className='inline text-xl text-red-600'>*</p></div>
                      <input
                        type="text"
                        id="pincode"
...
const Page2 = ({currentPage, formData, setFormData, nextPage, previousPage, display}) => {
  ...
  const changeBloodGroup = (event) => {
    setFormData((prevData) => ({
      ...prevData, blood_group: event.target.value
    }));
  }
          ...
          <div className='w-full h-full bg-defaultBg flex justify-center font-popins'>
            <div className="bg-white  w-10/12 h-auto mt-8 border-none rounded-lg flex justify-center font-popins">
              <div className='w-5/6 h-auto mt-5 mb-5 ml-6 mr-6 flex flex-col font-popins'>
                ...
                <div className='w-full h-auto flex justify-between mt-4'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium " htmlFor="email_id">Blood Group <p
                      className='inline text-xl text-red-600'></p></div>
                    <select
                      disabled={display}
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium " htmlFor="medical_history"> Medical
                        History <p className='inline text-xl text-red-600'></p></div>
                      <input
                        disabled={display}
                        type="text"
                        id="medical_history"
              ...
              <div className='w-11/12 h-1/2 flex justify-between'>
                ...
                <div className='w-52 flex flex-col justify-center'>
                  ...
                  <button onClick={handlePrevPage}
                          className='h-10 bg-accent2 text-lg font-semibold text-white border-none rounded-2xl mt-5'>
                    Previous Page
                  </button>
                </div>
              </div>
...
const Page3 = ({currentPage, formData, setFormData, nextPage, previousPage, display}) => {
  ...
  const handleChange1 = (event) => {
    setFormData((prevFormData) => ({
      ...prevFormData, hostel_name_or_id: event.target.value,
    }));
  };
            ...
            <div className="bg-white  w-10/12 h-auto mt-8 border-none rounded-lg flex justify-center font-popins">
              <div className='w-5/6 h-auto mt-5 mb-5 ml-6 mr-6 flex flex-col font-popins'>
                ...
                <div className='w-full h-auto flex flex-col mt-1'>
                  <div className="mb-1 font-popins text-lg font-medium" htmlFor="description">Select Hostel Name or ID
                    *
                  </div>
                  <select
                    id="hostel_name_or_id"
                    name="hostel_name_or_id"
                    value={formData.hostel_name_or_id} // Use formData.hostel_name_or_id to pre-select the dropdown
                    // option based on the state
                ...
                <div className='w-full h-auto flex justify-between mt-3'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium" htmlFor="email_id">Personal Contact Number <p
                      className='inline text-xl text-red-600'>*</p></div>
                    <input
                      type='text'
                      id="personal_mobile"
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium" htmlFor="email_id">Parents Contact Number <p
                        className='inline text-xl text-red-600'>*</p></div>
                      <input
                        type="text"
                        id="parent_mobile"
                ...
                <div className='w-full h-auto flex justify-between mt-3'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">Personal Email ID<p
                      className='inline text-xl text-red-600'>*</p></div>
                    <input
                      type="text"
                      id="personal_email"
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium" htmlFor="email_id">Parents Email ID<p
                        className='inline text-xl text-red-600'></p></div>
                      <input
                        type="text"
                        id="parent_email"
                ...
                <div className='w-full h-auto flex justify-between mt-2'>
                  <div className='w-1/2 flex flex-col items-start'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium" htmlFor="email_id">Family Income (lakh per
                        annum)<p className='inline text-xl text-red-600'></p></div>
                      <input
                        type="number"
                        id="income"
                        disabled={display}
                ...
                <div
                  className='underline  underline-offset-1 text-sky-950 text-2xl font-semibold pt-4 mt-1 mb-3 font-popins'>
                  <p className=' font-popins'>College details </p>
                </div>
                
                <div className='w-full h-auto flex justify-between mt-2'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">College Name<p
                      className='inline text-xl text-red-600'>*</p></div>
                    <input
                      type="text"
                      id="collage_name"
                ...
                <div className='w-full h-auto flex justify-between mt-2'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">College Address Line 1<p
                      className='inline text-xl text-red-600'>*</p></div>
                    <input
                      type="text"
                      id="college_address1"
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium   " htmlFor="email_id">College Address Line
                        2 <p className='inline text-xl text-red-600'></p></div>
                      <input
                        type="text"
                        id="college_address2"
                ...
                <div className='w-full h-auto flex justify-between mt-3'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">Principle Name<p
                      className='inline text-xl text-red-600'>*</p></div>
                    <input
                      type="text"
                      id="principle_name"
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium   " htmlFor="email_id">Principle Contact
                        Number <p className='inline text-xl text-red-600'>*</p></div>
                      <input
                        type="text"
                        id="teacher_mobile"
                        name="teacher_mobile"
                ...
                <div className='w-full h-auto flex justify-between mt-3'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">Principle Email ID<p
                      className='inline text-xl text-red-600'></p></div>
                    <input
                      type="text"
                      id="teacher_email"
...
const Page4 = ({currentPage, previousPage, formData, setFormData, display, edit, review}) => {
  ...
  const handleSubmit = (e) => {
    ...
    const formErrors = [];
    if (Object.keys(formErrors).length === 0) {
      axios.post(`${SecretKeys.API_URL}/student/registration`, formData).then((response) => {
        alert(response.data);
        ...
        <form>
          ...
          <div className='w-full h-full bg-defaultBg flex justify-center font-popins'>
            <div className="bg-white w-10/12 h-auto mt-10 border-none rounded-lg flex justify-center font-popins">
              <div className='w-5/6 h-auto mt-5 mb-5 ml-6 mr-6 flex flex-col font-popins'>
                <div
                  className='underline  underline-offset-1 text-sky-950 text-2xl font-semibold pt-4 mt-1 mb-1 font-popins'>
                  <p className=' font-popins'>Bank Details </p>
                </div>
                
                <div className='w-full h-auto flex justify-between mt-4'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">Account Holder Name<p
                      className='inline text-xl text-red-600'></p></div>
                    <input
                      type="text"
                      disabled={display}
                    ...
                    {errors.account_holder_name &&
                      <span className="error text-red-500">{errors.account_holder_name}</span>}
                  </div>
                  
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium" htmlFor="email_id">Bank name<p
                        className='inline text-xl text-red-600'></p></div>
                      <input
                        type="text"
                        disabled={display}
                ...
                <div className='w-full h-auto flex justify-between mt-4'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">IFSC<p
                      className='inline text-xl text-red-600'></p></div>
                    <input
                      type="text"
                      disabled={display}
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium" htmlFor="email_id">Account Number<p
                        className='inline text-xl text-red-600'></p></div>
                      <input
                        type="number"
                        disabled={display}
                ...
                <div className='w-full h-auto flex justify-between mt-4'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">Photo <p
                      className='inline text-xl text-red-600'>*</p></div>
                    <input
                      type="file"
                      disabled={display}
                      ...
                      className='w-full border-gray-400 rounded-md font-montserrat px-1 py-1 focus:outline-none border-1 focus:border-orange-600 focus:border-1.5'
                    />
                    {selectedFile && (<img src={previewURL} alt="Preview"
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium" htmlFor="email_id">Aadhar<p
                        className='inline text-xl text-red-600'>*</p></div>
                      <input
                        type="file"
                        disabled={display}
                ...
                <div className='w-full h-auto flex justify-between mt-4'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">Caste Certificate <p
                      className='inline text-xl text-red-600'>*</p></div>
                    <input
                      type="file"
                      disabled={display}
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium" htmlFor="email_id">Medical Certificates<p
                        className='inline text-xl text-red-600'></p></div>
                      <input
                        type="file"
                        disabled={display}
                ...
                <div className='w-full h-auto flex justify-between mt-4'>
                  <div className='w-1/2'>
                    <div className="mb-1 font-popins text-lg font-medium  " htmlFor="email_id">Income Certificate <p
                      className='inline text-xl text-red-600'></p></div>
                    <input
                      type="file"
                      disabled={display}
                  ...
                  <div className='w-1/2 flex flex-col items-end'>
                    <div className='w-11/12'>
                      <div className="mb-1 font-popins text-lg font-medium" htmlFor="email_id">Bank Details<p
                        className='inline text-xl text-red-600'></p></div>
                      <input
                        type="file"
                        disabled={display}
...
const StudentRegistartion = (props) => {
  ...
  return (<>
      ...
      {currentPage === 2 && (<Page2 currentPage={currentPage} formData={existingformData ? formData : existingformData}
                                    setFormData={setFormData} nextPage={nextPage} previousPage={previousPage}
                                    display={props.display}/>)}
      {currentPage === 3 && (
        <Page3 currentPage={currentPage} formData={formData} setFormData={setFormData} nextPage={nextPage}
               previousPage={previousPage} display={props.display}/>)}
      {currentPage === 4 && (
        <Page4 currentPage={currentPage} formData={formData} setFormData={setFormData} previousPage={previousPage}
               display={props.display} edit={props.edit} review={props.Review}/>)}
    </>
